...
@Component({
  selector: 'app-studentswob',
  templateUrl: './studentswob.component.html',
  styleUrls: ['./studentswob.component.css']
})
export class StudentswobComponent implements OnInit {
  ...
  private getStudents(): void {
    this.studentService.getStudentsListwob().subscribe(
      (data: Student[]) => {
  ...
  updateStudent(id: number): void {
    window.location.href=`/update-students/`
  }
